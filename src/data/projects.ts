...
export const PROJECTS: Project[] = [
    ...
    },
    {
        ...
        titleEn: 'Sijli.com',
        category: 'نظام مدرسي',
        desc: 'سجل المتابعة الرقمي — الحصة والرصد والدرجات وبوابة الطالب ووليّ الأمر في نظام واحد.',
        longDesc:
            'نظام مدرسي متكامل يحوّل دفتر المتابعة الورقي إلى حصةٍ حيّة تُدار من الجوال: يرصد المعلم الحضور والمشاركة والواجب والسلوك بلمسة، فتُحتسب الدرجات تلقائياً وتصل وليّ الأمر لحظتها. ومعه مسرح درسٍ تفاعلي بسبع محطات — عرض وقصة مصوّرة وسرد صوتي ومصطلحات وسبع ألعاب صفّية — وأوراق عمل تُرسل إلى حسابات الطلاب وتُصحَّح آلياً. ولوحة مدير المدرسة ترى المدرسة كلها: الجدول والتعارضات والمستويات والتقارير وإدارة الطلاب والمعلمين.',
        image: 'https://images.unsplash.com/photo-1580582932707-520aed937b7b?auto=format&fit=crop&q=80&w=2000',
        tags: ['PWA', 'Firebase', 'Education'],
        url: 'https://sijli.erihdev.com',
        features: [
            { title: 'الحصة الحيّة', desc: 'رصد الحضور والمشاركة والواجب والسلوك بلمسة واحدة أثناء الشرح' },
            { title: 'درجات تلقائية', desc: 'الرصد اليومي يتحوّل درجاتٍ محسوبة، وما يكتبه المعلم يدوياً يغلب دائماً' },
            { title: 'مسرح الدرس', desc: 'سبع محطات: عرض وقصة مصوّرة بسرد صوتي ومصطلحات وألعاب صفّية' },
            { title: 'أوراق تفاعلية', desc: 'تصل حساب الطالب فوراً وتُصحَّح آلياً وتدخل درجاته' },
            { title: 'بوابة الطالب ووليّه', desc: 'مستوى الابن لحظةً بلحظة أثناء الحصة، ولوحة شرف، وشهادة تميّز' },
            { title: 'لوحة مدير المدرسة', desc: 'الجدول والتعارضات والمستويات والتقارير وإدارة الطلاب والمعلمين' },
        ],
        stack: ['JavaScript', 'PWA', 'Firebase', 'Firestore Rules', 'Web Push', 'Three.js'],
    },
    {
        slug: 'markmap',
        title: 'مارك ماب',
